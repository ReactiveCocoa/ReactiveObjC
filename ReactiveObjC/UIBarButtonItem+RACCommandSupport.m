...
- (void)setRac_command:(RACCommand *)command {
  objc_setAssociatedObject(self, UIControlRACCommandKey, command,
  ...
  objc_setAssociatedObject(self, UIControlEnabledDisposableKey, disposable,
                           OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (void)rac_hijackActionAndTargetIfNeeded {
  ...
  if (self.target != nil)
    NSLog(
        @"WARNING: UIBarButtonItem.rac_command hijacks the control's existing target and action.");
