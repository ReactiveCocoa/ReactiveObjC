...
+ (dispatch_time_t)wallTimeWithDate:(NSDate *)date {
  ...
  struct timespec walltime = {.tv_sec = (time_t)fmin(fmax(seconds, LONG_MIN), LONG_MAX),
...
- (RACDisposable *)after:(NSDate *)date
  ...
  dispatch_source_set_timer(timer, [self.class wallTimeWithDate:date], intervalInNanoSecs,
                            leewayInNanoSecs);
