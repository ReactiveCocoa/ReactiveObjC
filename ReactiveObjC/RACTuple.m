...
- (instancetype)init {
  return [super
      initWithBackingArray:@[ RACTupleNil.tupleNil, RACTupleNil.tupleNil, RACTupleNil.tupleNil ]];
}
...
- (instancetype)init {
  return [self initWithBackingArray:@[
    RACTupleNil.tupleNil, RACTupleNil.tupleNil, RACTupleNil.tupleNil, RACTupleNil.tupleNil
  ]];
}
