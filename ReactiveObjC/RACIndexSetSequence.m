...
+ (instancetype)sequenceWithIndexSetSequence:(RACIndexSetSequence *)indexSetSequence
...
- (NSString *)description {
  ...
  return [NSString stringWithFormat:@"<%@: %p>{ name = %@, indexes = %@ }", self.class, self,
                                    self.name, indexesStr];
}
